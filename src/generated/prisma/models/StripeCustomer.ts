...
export type StripeCustomerOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"customerId" | "organizationId" | "eventAt" | "subscriptionId" | "subscriptionStatus" | "productId" | "priceId", ExtArgs["result"]["stripeCustomer"]>
...
export interface StripeCustomerDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const stripeCustomerWithCustomerIdOnly = await prisma.stripeCustomer.findMany({ select: { customerId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many StripeCustomers and only return the `customerId`
   * const stripeCustomerWithCustomerIdOnly = await prisma.stripeCustomer.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more StripeCustomers and only return the `customerId`
   * const stripeCustomerWithCustomerIdOnly = await prisma.stripeCustomer.updateManyAndReturn({
   *   select: { customerId: true },
   *   where: {
   *     // ... provide filter here
   *   },
